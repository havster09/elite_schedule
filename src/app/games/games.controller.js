(function () {
    ...
    GamesCtrl.$inject = ['$scope','$modal','$http', '$location', '$stateParams'];

    /* @ngInject */
    function GamesCtrl($scope,$modal, $http, $stateParams) {
        ...
        $http.get("app/setup/data-games.json")
        ...
        $http.get("app/setup/data-teams.json")
            .success(function(response) {
                vm.teams = response;
                activate();
            });
